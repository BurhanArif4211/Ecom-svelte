...
<script>
	...
	import { SOCIALS_VISIBLE, cart, fetchCart } from "./lib/stores";
...
<svelte:head>
	...
	<meta
		name="description"
		content="Shop our collection of auto parts, lights, tools, helmets and gadgets with fast delivery and great prices"
	/>
</svelte:head>
