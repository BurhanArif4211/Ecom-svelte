...
<script>
    ...
    const socialLinks = {
        whatsapp: {
            url: 'https://wa.me/923193872840', // Replace with actual number
            color: 'bg-green-500 hover:bg-green-600'
        },
        facebook: {
            url: 'https://www.facebook.com/people/Auto-GearLift/61575619365709/', // Replace with actual page
            color: 'bg-blue-600 hover:bg-blue-700'
        },
        instagram: {
            url: 'https://instagram.com/autogearlift', // Replace with actual handle
            color: 'bg-pink-600 hover:bg-pink-700'
        }
    };
    
    const openChat = (platform) => {
        window.open(socialLinks[platform].url, '_blank', 'noopener,noreferrer');
    };
</script>
